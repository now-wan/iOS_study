...
extension OnboardingMessage {
    static let messages: [OnboardingMessage] = [
        ...
        OnboardingMessage(imageName: "img_nike_group_run", title: "MUSIC MOVES YOU 추가내용", description: "You're first race, last mile, or push out the door whatever your pace, distance or need, we've got the playlist to match 추가 내용"),
    ]
